    ...
    return (
        <div>
            ...
            <div>
                ...
                <img style={{ height: '30em', width: 'inherit'}} src={require('../images/20220103_115224.jpg')} alt='redOrangeDice'/>
                <div sx={{ border: 1 }} style={{display: 'flex', flexDirection: 'row', margin: '3em'}}>
                    <div>
                        <img style={{ height: '30em'}} src={require('../images/20220103_142517.jpg')} alt='mainIris'/>
                    </div>
